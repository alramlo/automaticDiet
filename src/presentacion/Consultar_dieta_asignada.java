...
import presentacion.tablas.Tabla_dieta_semanal;
...
public class Consultar_dieta_asignada extends JPanel
{
	...
	public Consultar_dieta_asignada(Controlador c)
	{
		...
		btn_lista_compra.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		btn_modificar.setHorizontalAlignment(SwingConstants.RIGHT);
		btn_modificar.setFont(new Font("Arial", Font.PLAIN, 14));
		btn_detalle.setIconTextGap(10);
		btn_detalle.setMinimumSize(new Dimension(32, 32));
		btn_detalle.setMaximumSize(new Dimension(32, 32));
		btn_detalle.setIcon(new ImageIcon(Consultar_dieta_asignada.class.getResource("/media/iconos/lupa.png")));
		
		
		btn_detalle.setHorizontalAlignment(SwingConstants.RIGHT);
			...
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(lbl_fecha_actual, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
